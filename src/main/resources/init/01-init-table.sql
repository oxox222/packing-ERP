DROP TABLE `t_save_record`;
DROP TABLE `table_1`;
DROP TABLE `t_save_goods`;
DROP TABLE `t_goods_type_info`;
DROP TABLE `t_ supplier`;
DROP TABLE `t_fetch_record`;
DROP TABLE `t_ warehouse`;
DROP TABLE `t_fetch_goods_info`;
DROP TABLE `t_fetch_goods`;
DROP TABLE `t_ dictionary`;

CREATE TABLE `t_save_record` (
`t_id` int(255) NOT NULL AUTO_INCREMENT COMMENT '主键',
`t_odd` varchar(255) NOT NULL COMMENT '单号',
`t_ warehouseId` int(11) NOT NULL COMMENT '仓库',
...
`t_ supplierId` int(255) NOT NULL COMMENT '供应商id',
...
CREATE TABLE `t_goods_type_info` (
...
`t_ salesman` varchar(255) NULL COMMENT '销售员',
`t_create_date` datetime(11) NOT NULL ON UPDATE CURRENT_TIMESTAMP(11),
`t_ deliverWay` varchar(255) NULL COMMENT '发货方式',
...
CREATE TABLE `t_fetch_goods_info` (
`t_id` int(255) NOT NULL AUTO_INCREMENT COMMENT '主键',
`t_recordId` int(255) NOT NULL COMMENT '出库表id',
`t_name` varchar(255) NOT NULL COMMENT '商品名',
`t_goods` varchar(255) NOT NULL COMMENT '商品编号',
`t_price` double(10,2) NOT NULL COMMENT '单价',
`t_discount` float(10,0) NOT NULL DEFAULT 1.0 COMMENT '折扣',
`t_discount_price` double(10,2) NOT NULL COMMENT '折后价',
`t_num` int NOT NULL COMMENT '数量',
`t_type` int(11) NOT NULL COMMENT '商品类型 1 原材料 2半成品 3成品',
PRIMARY KEY (`t_id`) 
)
COMMENT = '出库商品表';
