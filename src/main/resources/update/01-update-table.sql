...
-- t_fetch_record和t_save_record表t_paid设置为空
ALTER TABLE t_fetch_record MODIFY COLUMN t_paid double(11,2) NULL COMMENT '实收金额';
ALTER TABLE t_save_record MODIFY COLUMN t_paid double(11,2) NULL COMMENT '实付金额';
